...
public:
    ...
    virtual std::map<org::yaorm::ProtobufType, std::string> proto_type_to_sql_type;

    virtual std::map<std::string, org::yaorm::ProtobufType> sql_type_to_proto_type;

    virtual int get_bulk_insert_size() = 0;

    virtual bool insert_same_as_update() = 0;

    virtual std::string text_type_name = 0;
    virtual std::string integer_type_name = 0;
    virtual std::string real_type_name = 0;
    virtual std::string blob_type_name = 0;
