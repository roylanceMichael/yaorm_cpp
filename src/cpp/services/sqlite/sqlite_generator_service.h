...
public:
    ...
    std::string build_drop_index(org::yaorm::Definition, std::vector<org::yaorm::PropertyDefinition> columns);
    ...
    std::string build_select_all(org::yaorm::Definition, int n = 1000);
    std::string build_where_clause(org::yaorm::Definition, org::yaorm::WhereClauseItem where_clause);
