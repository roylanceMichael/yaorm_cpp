...
#include "sqlite/sqlite_proto_generator_service_tests.h"
...
//
//    SQLiteProtoGeneratorServiceTests proto_tests;
//    proto_tests.simple_check_ok();
//    proto_tests.simple_check_child_ok();
//    proto_tests.simple_create_table_test();
}
